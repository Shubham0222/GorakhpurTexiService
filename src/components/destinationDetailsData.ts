export const destinationDetails = {
  ...
  gitapress: {
    title: 'Gorakhpur to Gita Press Taxi Service',
    description: 'World\'s largest publisher of Hindu religious texts, a must-visit for spiritual seekers.',
    image: '/assets/image/destinations/gita-press.jpg',
    places: [
      'Gita Press Museum',
      'Book Store',
      'Nearby Temples',
  ...
  ramgarhtal: {
    title: 'Gorakhpur to Ramgarh Tal Taxi Service',
    description: 'Beautiful lake and recreational area, perfect for family outings and boating.',
    image: '/assets/image/destinations/ramgarh-tal.jpg',
    places: [
      'Ramgarh Tal Lake',
      'Boating Club',
      'Water Sports',
